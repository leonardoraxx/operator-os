        ...
        <div className="space-y-4">
          ...
          <GlassCard header={{ icon: User, title: "Profile" }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[
                { label: "Display Name", value: OPERATOR.name },
                { label: "Handle", value: OPERATOR.handle },
          ...
          <GlassCard header={{ icon: Plug, title: "Integrations" }}>
            <div className="space-y-2">
              {[
                { name: "Supabase", desc: "Database & Auth - Phase 2", status: "Pending" },
                { name: "Notion", desc: "Notes sync", status: "Not connected" },
                { name: "Google Calendar", desc: "Calendar sync", status: "Not connected" },
